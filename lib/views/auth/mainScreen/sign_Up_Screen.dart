...
class _SingUpScreenState extends State<SingUpScreen> {
  ...
  DropdownButtonController_Ahmed dropC =
      Get.put(DropdownButtonController_Ahmed());
  @override
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    MyTextFiledPassword(
                      thisController: from.passwordController,
                      text: 'password',
                    ),
                    MyTextFiledPassword(
                        thisController: from.passwordReController,
                        text: 're_password'.tr,
                    ...
                    Obx(() {
                      return Container(
                          ...
                          child: RemoteServices.isloading.value
                                  ...
                                  onPressed: () async {
                                    if (formKey.currentState!.validate()) {
                                      ...
                                      var json = {
                                        ...
                                        "password1":
                                            from.passwordController.text,
                                        "password2":
                                            from.passwordReController.text,
                                        "gender": dropC.getGender(),
                                        "stage": stageC.find_stage(
                                            dropC.selectedItem2.value)
                                      };
                                      ...
                                      if (RemoteServices.sc == 202) {
                                        ...
                                        Get.offAll(() => sucessScreen(
                                              title: 'title_signup_screen'.tr,
                                              body: 'body_signup_screen'.tr,
                                              image:
                                                  'assets/images/sign_Up_Successfully.png',
                                            ));
                                      }
                                    }
                                  }));
