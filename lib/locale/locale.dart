...
class MyLocale implements Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ar': {
          ...
          'body_new_password':
              'تم تحديث كلمة المرور الخاصة بك ، اضغط على الزر أدناه للعودة إلى شاشة تسجيل الدخول',
          'back_to_login': 'العودة إلى تسجيل الدخول',
          'exit': 'هل تريد الخروج؟',
          'back to login': 'هل تريد العوده الى صفحه تسجيل الدخول؟',
          'exit exam':
              'هل تريد مغادره الامتحان؟ (سوف تعتبر باقي الاسئله خاطئه)',
          'timeout':
              'لقد انتهى وقت الامتحان!! اضغط على الزر في الاسفل لمعرفه نتيجتك',
          'yes': 'نعم',
          'ok': 'موافق',
          'no': 'لا',
          ...
          'body_signup_screen':
              'لقد قمت بالتسجيل بنجاح ، لقد أرسلنا رابط تأكيد إلى بريدك الإلكتروني',
          /////////////////////
          ////////////////////
          //////////////////////
          /////////////////////
          ...
          'titelOn1': 'تعليم',
          'descripOn1':
              'يتضمن تطبيق امتحاني اختبارات في جميع المواد الدراسية ولكافة المراحل',
          'titelOn2': 'ميزات',
          'descripOn2': 'من مميزات التطبيق خزن اختباراتك ومعرفة نقاط ضعفك',
          'titelOn3': 'اخيرا',
          'descripOn3':
              'يساعدك تطبيق امتحاني على اختبار نفسك وتجاوز صعوبات المواد الدراسيه',
        },
        'en': {
          'login': 'Login',
          'loginn': 'Login',
          ...
          'body_new_password':
              'Your password have been updated, press the button below to go back to login screen',
          'back_to_login': 'Back to Login',
          'exit': 'Do you want to exit?',
          'back to login': 'Do you want to go back to login?',
          'exit exam':
              "Are you sure you want to quit the quiz?(unsubmitted questions will be considered incorrect)",
          'timeout':
              'Quiz time is over!!, press the buttom below to view your score',
          'yes': 'Yes',
          'OK': 'OK',
          'no': 'No',
          'title_signup_screen': 'Confirm your account',
          'body_signup_screen':
              'you have successfully signed up, we have send a confirmation link to your email',
          /////////////////////
          ////////////////////
          //////////////////////
          /////////////////////
          ...
          'titelOn1': 'Education',
          'descripOn1':
              'Amtihane application includes tests in all subjects for all levels',
          'titelOn2': 'Advantages',
          'descripOn2':
              'One of the features of the application is to store your tests and know your weaknesses',
          'titelOn3': 'Finally',
          'descripOn3':
              'Amtihane application helps you to test yourself and overcome the difficulties of study subjects',
        },
      };
}
